...
$connect_street = $_POST['connect-street'];
$connect_name = $_POST['connect-name'];
$connect_tel = $_POST['connect-tel'];
...
$mail->Body = $body = 'Заявка с сайта Lifelink:<br>' . $connect_name . ' оставил заявку на подключение.<br> Его телефон: ' . $connect_tel . '<br>Улица: ' . $connect_street ;
$mail->AltBody = '';
