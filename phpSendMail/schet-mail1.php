...
$schet_num = $_POST['schet-num'];
$schet_sum = $_POST['schet-sum'];
...
$mail->Body = $body = 'Заявка с сайта Lifelink:<br> Пользователь хочет пополнить счет.<br> Его платежный номер: ' . $schet_num . '<br>Сумма ' . $schet_sum ;
$mail->AltBody = '';
